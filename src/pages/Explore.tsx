...
export default function Explore() {
  ...
  const performSearch = (query: string) => {
    ...
    const results = mockExoplanets.filter(planet => 
                    ...
                    >
                      ...
                      <CardContent>
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          <div>
                            <span className="text-muted-foreground">{t('object.radius')}:</span>
                            <span className="ml-2 font-medium">{planet.radius} R⊕</span>
                          </div>
                          <div>
                            <span className="text-muted-foreground">{t('object.mass')}:</span>
                            <span className="ml-2 font-medium">{planet.mass} M⊕</span>
                          </div>
                          <div>
                            <span className="text-muted-foreground">{t('object.period')}:</span>
                            <span className="ml-2 font-medium">{planet.period} days</span>
                          </div>
                          <div>
                            <span className="text-muted-foreground">{t('object.distance')}:</span>
                            <span className="ml-2 font-medium">{planet.distance} ly</span>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
                ...
                <Card className="cosmic-shadow">
                  <CardHeader>
                    <CardTitle className="font-orbitron">
                      {selectedObject ? selectedObject.name : 'Solar System'} - 3D View
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <ThreeViewer 
                    ...
                    {selectedObject && (
                      <div className="mt-4 p-4 bg-muted/50 rounded-lg">
                        <h4 className="font-semibold mb-2">{selectedObject.name}</h4>
