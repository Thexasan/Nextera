  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in">
            <Button
              asChild
              size="lg"
              className="stellar-glow animate-pulse-glow"
            >
              <Link to="/explore">
        ...
        <div
          className="absolute bottom-40 right-32 animate-float"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="cosmic-shadow hover:stellar-glow transition-all duration-cosmic">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground">
                  {t("home.visualization.description")}
                </p>
              </CardContent>
            </Card>
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen">
          <div className="text-center px-4">
            ...
            <Button
              asChild
              size="lg"
              className="nebula-glow animate-pulse-glow"
            >
              <Link to="/explore">
