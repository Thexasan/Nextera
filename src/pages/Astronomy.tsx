...
export default function Astronomy() {
  ...
  const getPlanetName = (planet: (typeof planetData)[0]) => {
    switch (currentLang) {
      case "ru":
        return planet.nameRu;
      case "es":
        return planet.nameEs;
      default:
        return planet.name;
    }
  };
  ...
  const getPlanetFacts = (planet: (typeof planetData)[0]) => {
    return (
      planet.facts[currentLang as keyof typeof planet.facts] || planet.facts.en
    );
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
            <Card className="cosmic-shadow text-center">
              <CardContent className="p-6">
                ...
                <h3 className="font-orbitron font-semibold mb-2">
                  {t("astronomy.quick.planets")}
                </h3>
                <p className="text-sm text-muted-foreground">
                  {t("astronomy.quick.inSystem")}
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="cosmic-shadow text-center">
              <CardContent className="p-6">
                ...
                <h3 className="font-orbitron font-semibold mb-2">
                  {t("astronomy.quick.moons")}
                </h3>
                <p className="text-sm text-muted-foreground">
                  {t("astronomy.quick.naturalSatellites")}
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="cosmic-shadow text-center">
              <CardContent className="p-6">
                ...
                <h3 className="font-orbitron font-semibold mb-2">
                  {t("astronomy.quick.exoplanets")}
                </h3>
                <p className="text-sm text-muted-foreground">
                  {t("astronomy.quick.discoveredToDate")}
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="cosmic-shadow text-center">
              <CardContent className="p-6">
                ...
                <h3 className="font-orbitron font-semibold mb-2">
                  {t("astronomy.quick.universeAgeTitle")}
                </h3>
                <p className="text-sm text-muted-foreground">
                  {t("astronomy.quick.universeAgeSubtitle")}
                </p>
              </CardContent>
            </Card>
          </div>
              ...
              >
                <CardHeader className="text-center">
                  ...
                  <Badge variant="secondary" className="w-fit mx-auto">
                    {planet.distance} {t("astronomy.fromSun")}
                  </Badge>
                </CardHeader>
                ...
                <CardContent>
                  ...
                  <div className="border-t border-border pt-4">
                    <h4 className="font-semibold mb-2 text-sm">
                      {t("astronomy.quickFacts")}
                    </h4>
                    <ul className="space-y-1">
                      {getPlanetFacts(planet)
                        .slice(0, 2)
                        .map((fact, index) => (
                          <li
                            key={index}
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        `https://solarsystem.nasa.gov/planets/${planet.name.toLowerCase()}/`,
                        "_blank"
                      )
                    }
                  >
                    <Rocket className="w-4 h-4 mr-2" />
                    {t("astronomy.learnMore")}
                  </Button>
                </CardContent>
              </Card>
            ))}
          ...
          <div className="mt-16 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                ...
                {t("astronomy.links.exoplanetArchive")}
              </Button>
              <Button
                size="lg"
                variant="outline"
                onClick={() =>
                  window.open("https://solarsystem.nasa.gov/", "_blank")
                }
              >
                <Globe className="mr-2 h-5 w-5" />
                {t("astronomy.links.solarSystemExploration")}
              </Button>
            </div>
          </div>
        </div>
